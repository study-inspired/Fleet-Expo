        ...
        return (
            ...
            <View style={{ flex:1, marginHorizontal: 25, flexDirection: 'column' }}>
                <View style={{ flex:1, justifyContent: 'center', alignItems: "center" }}>
                    ...
                    <Text style={{ textAlign: 'center', fontFamily: 'aller-bd', fontSize: 16 }}>Factura del vehículo</Text>
                </View>
                <View style={{ flex:1, marginHorizontal: 25, alignItems: "center", marginTop:18 }}>
                    ...
                    <Text style={styles.textoNormal}>Sube una foto de la factura del vehículo que sea vigente y donde se muestren sus datos.</Text>
