...
export default class AddHologram extends React.Component {
    ...
    async _openGalery() {
        ...
        if (!result.cancelled) {
            this.props.navigation.navigate('AttachedPicture', { 
                ...
                niv: this.props.navigation.getParam('id_usuario', '01234567891234567')
            })
        }
    }
        ...
        return (
            <View style={{ flex:1, marginHorizontal: 25, flexDirection: 'column' }}>
                <View style={{ flex:1, justifyContent: 'center', alignItems: "center" }}>
                    ...
                    <Text style={{ textAlign: 'center', fontFamily: 'aller-bd', fontSize: 16 }}>Holograma ambiental</Text>
                </View>
                <View style={{ flex:1, marginHorizontal: 25, alignItems: "center", marginTop:18 }}>
                    ...
                    <Text style={styles.textoNormal}>Sube una foto del holograma ambiental del vehículo que sea vigente y donde se muestren sus datos.</Text>
